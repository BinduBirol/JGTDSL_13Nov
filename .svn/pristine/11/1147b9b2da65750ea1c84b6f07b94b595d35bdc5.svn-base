				...
				<div class="w-box-content" style="padding: 10px;" id="content_div">
						...
						<div class="row-fluid">							
							<div class="span6">									    
								...
								<input type="text" value=0 style="width: 52%" name="due_date" id="due_date"  maxlength="30"/>						      
							</div>
							<div class="span6">
								<label style="width: 40%">Due Month<m class='man'/></label>
								<input type="text" style="width: 52%" value=0 name="month_number" id="month_number"  maxlength="2"/>							      
						...
						<div class="span6">	
						<label style="width: 40%">Defaulter Type</label>			
							<select name="dType" id="dtype" style="width: 56%;margin-left: 0px;">
							       	<option value="1">Defaulter</option> 
							       	<option value="0">non-defaulter</option>               
    ...
    function fetchDefalterList() {
        ...
        $.ajax({
            ...
            data    : {
				...
				billYear: $("#bill_year").val(), dueDate: $("#due_date").val(), monthNumber: $("#month_number").val(), dType: $("#dtype").val()
            }
        	}).done(function (msg) {
        			$("#stat_div").hide();
                    $("#detailDiv").html(msg);
