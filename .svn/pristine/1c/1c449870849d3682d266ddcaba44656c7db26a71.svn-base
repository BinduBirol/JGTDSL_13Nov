		...
		PreparedStatement stmt = null;
			try
			{
				...
				if(customer.getConnectionInfo().getIsMetered_str().equals("0"))
		        {
					...
					stmt.setString(9,customer.getConnectionInfo().getDouble_burner_qnt()) ;
					stmt.setString(10,customer.getConnectionInfo().getDouble_burner_qnt().toString());		
				...
				if(customer.getConnectionInfo().getIsMetered_str().equals("0"))
		        {
					...
					stmt.setString(2,customer.getConnectionInfo().getDouble_burner_qnt());
					stmt.setString(3,customer.getConnectionInfo().getDouble_burner_qnt());
					stmt.setString(4,customer.getConnectionInfo().getDouble_burner_qnt());
					stmt.setString(5,customer.getConnectionInfo().getDouble_burner_qnt());
