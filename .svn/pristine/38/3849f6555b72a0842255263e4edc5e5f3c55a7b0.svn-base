		...
		<div class="span12" id="rightSpan">
			<div class="w-box">
				<div class="w-box-header">
    				<h4 id="rightSpan_caption">Codeless Collection Report</h4>
				</div>
				<div class="w-box-content" style="padding: 10px;" id="content_div">
				
     				<form id="billProcessForm" name="billProcessForm" action="CodelessCollectionReport.action" style="margin-bottom: 1px;">
     				
     						<div class="alert alert-info">
									<table width="100%" align="center">
										<tr>
											<td width="100%" align="right" style="font-size: 12px;font-weight: bold;">
												<input type="checkbox" value="Co_Coll" id="Co_Coll" name="report_for" checked="checked" /> All Codeless connection&nbsp;&nbsp;&nbsp;
