...
public class CustomerListReport extends BaseAction {
	...
	public String execute() throws Exception
	{
		...
		try{
			...
			}else if(report_for.equals("disconnected")){
				generatePdfAllDisconnected(document);
			}
	...
	/* All	Disconnected customer 
	 * 
	 * @sujon
	 * */
	
	private void generatePdfAllDisconnected(Document document) throws DocumentException
	{
		document.setMargins(20,20,30,72);
