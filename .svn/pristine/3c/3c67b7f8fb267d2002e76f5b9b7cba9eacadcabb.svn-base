...
<div class="row-fluid">
	<div class="span4">
		<label style="color: blue;">Dated</label> <input type="text"
			name="deposit.deposit_date" id="deposit_date" style="width: 54%;"
			value="<s:property value='deposit.deposit_date' />" />
	</div>
	<div class="span4">
		<label style="color: blue;">Deposit Purpose</label> <select
			name="deposit.str_deposit_purpose" id="deposit_purpose_id"
			style="width: 59%">
			<option value="">Deposit Purpose</option>
			<s:iterator value="%{#application.DEPOSIT_PURPOSE_FROM_DATABASE}">
				<option value="<s:property value='type_id'/>">
					<s:property value="type_name_eng" />
				</option>
			</s:iterator>
		</select>
	</div>
	<div class="span4">
		<label style="color: blue;">Total</label> <input type="text"
			name="deposit.total_deposit" id="total_deposit"
			style="width: 54%;border: 1px dotted magenta;text-align: right;font-weight: bold;" />
	</div>
</div>
...
<s:if test="form_mode=='edit'">
	...
	disableField("deposit_type_id","deposit_purpose_id");
