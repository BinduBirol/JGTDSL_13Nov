...
<div class="collection-form"  >
				...
				<div class="w-box-content" style="padding: 10px;" id="content_div">					
								...
								<div class="row-fluid">
									<div class="span6">
										...
										<select id="bank_id" name="collection.bank_id"  style="width: 54.5%;"   onchange="fetchSelectBox(branch_sbox)" onkeypress="selectvalue.apply(this, arguments),fetchSelectBox(branch_sbox)">
											...
											<s:iterator value="%{#session.USER_BANK_LIST_COL}">
							...
							<div class="row-fluid" id="from_bill_month_div">
					        	<div class="span12">
					         		<label style="width: 20%">From Month Year</label>        
					         			<input placeholder="Month" onkeypress="validate(event)" type="text" maxlength="2"  name="collection.from_month" id="from_month" tabindex="1" style="text-align: right;font-weight: bold;color: black;width: 11.2%; background-color: #FFFFF;"/>
					         			<input placeholder="Year" onkeypress="validate(event)" type="text" maxlength="4"    name="collection.from_year" id="from_year" tabindex="2" style="text-align: right;font-weight: bold;color: black;width: 11.2%; background-color: #FFFFF;"/>
					        	</div> 
					       ...
					       <div class="row-fluid" id="to_bill_month_div">
					        	<div class="span12">
					         		<label style="width: 20%">To Month Year</label>        
					         			<input placeholder="Month" onkeypress="validate(event)" type="text" maxlength="2"    name="collection.to_month" id="to_month" tabindex="3" style="text-align: right;font-weight: bold;color: black;width: 11.2%; background-color: #FFFFF;"/>
					         			<input placeholder="Year" onkeypress="validate(event)" type="text"  maxlength="4"   name="collection.to_year" id="to_year" tabindex="4" style="text-align: right;font-weight: bold;color: black;width: 11.2%; background-color: #FFFFF;"/>
					        	</div>
					        </div>	
						...
						<div class="row-fluid">								
							<div class="row-fluid" id="advanced_div" >
								<div class="span12">
									...
									<input type="number" name="collection.advanced_amount" id="advanced_amount" tabindex="3" style="text-align: right;font-weight: bold;color: black;width: 55% background-color: #FFFFF;"/>
								</div>
						...
						<div class="row-fluid" id="surcharge_div" >
								<div class="span12">	
									...
									<input type="number" name="collection.surcharge_amount" id="surcharge_amount" tabindex="2" style="text-align: right;font-weight: bold;color: black;width: 51% background-color: #FFFFF;"/>
								</div>												
							</div>
						</div>		
  ...
  <div class="month_help">
	<h4 style="padding-left: 100px; text-shadow: 2px 9px 5px #1C6EA4;">	
		01 -- January 	</br>
		02 -- February 	</br>
		03 -- March 	</br></br>
		04 -- April 	</br>
