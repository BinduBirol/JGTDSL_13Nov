	...
	<div class='row'><div class='col-sm-12'>
		...
		<table class='table table-bordered table-striped'>
			...
			<tbody>
				...
				<br>
					<tr>
						<td align=center colspan=1><strong>Sub Total Amount</strong></td>
						<td align=right colspan=2><strong><s:property value="subTotal"/></strong></td>
					</tr>
					<tr>
						<td align=center colspan=1><strong>Gateway Charge 1%</strong></td>
						<td align=right colspan=2><strong><s:property value="gatewayCharge"/></strong></td>
					</tr>
				
					<tr>
						<td align=center colspan=1><strong>Grand Total</strong></td>
...
<br/><br/>
	...
	<input class='btn btn-danger' type="button" value="Cancel" onclick='javasctipt:history.go(-1)' />
	</div>
</div>
