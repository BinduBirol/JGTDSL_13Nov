...
public class BillingNonMeteredDTO {
	...
	public double getJvNo() {
		return jvNo;
	}
	public void setJvNo(double jvNo) {
		this.jvNo = jvNo;
	}
	public double getJvWeaverAmount() {
		return jvWeaverAmount;
	}
	public void setJvWeaverAmount(double jvWeaverAmount) {
		this.jvWeaverAmount = jvWeaverAmount;
	}
