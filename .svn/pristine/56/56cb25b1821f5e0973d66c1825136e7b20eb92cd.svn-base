	...
	public String addAccount(String data)
	{
		...
		PreparedStatement stmt = null;
			try
			{
				...
				stmt.setString(1,accountDTO.getAccount_no());
				stmt.setString(2,accountDTO.getBank_id());
				stmt.setString(3,accountDTO.getBranch_id());
				stmt.setString(4,accountDTO.getAccount_type());
				stmt.setString(5,accountDTO.getAccount_name());
				stmt.setString(6,accountDTO.getAc_opening_date());
				stmt.setString(7,accountDTO.getOpening_balance());
				stmt.setString(8,accountDTO.getOpening_date());
				stmt.setString(9,accountDTO.getDescription());
				stmt.setInt(10,accountDTO.getStatus());
