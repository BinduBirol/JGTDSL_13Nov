...
<div id="customer_meter_div" style="height: 55%;width: 99%;">
	...
	<div style="width: 51%; height: 99%;float: left;margin-left: 1%;">
		...
		<div class="row-fluid" align="left" 
			style="min-height: 33%;width: 70%;margin-top: 0px;margin-left: 0%;">
...
<div id="customer_grid_div" style="height: 39%;width: 99%;">
	<div id="tabbed-nav">
		<ul>
			<li><a>Customer List (<font color="red"
					style="font-weight: bold;">Expire List</font>)
			</a></li>
			<li><a>Expire Change History (<font color="green"
					style="font-weight: bold;">For this customer</font>)
			</a></li>
		</ul>
		
		<form action="printBGExpireListWithIn365Days">
		<input type="text" id="hiddenDays" name="days" placeholder="Days to expire" />
...
<script type="text/javascript"
	src="/JGTDSL_WEB/resources/js/page/tabInitialization.js"></script>
<script type="text/javascript"
	src="/JGTDSL_WEB/resources/js/page/bankGarantieManagement.js"></script>
<script type="text/javascript"
	src="/JGTDSL_WEB/resources/js/page/jqGridDefault.js"></script>
<script type="text/javascript"
	src="/JGTDSL_WEB/resources/js/page/jqGridCommon.js"></script>
