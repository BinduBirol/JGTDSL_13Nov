		...
		<div class="span12" id="rightSpan">
			<div class="w-box">
				...
				<div class="w-box-content" style="padding: 10px;" id="content_div">
     				...
     				<form id="billProcessForm" name="billProcessForm" action="maxLoadExceedNotice.action" style="margin-bottom: 1px;">
						...
						<div class="row-fluid">							
							<div class="span6">									    
								<label style="width: 40%">Month-Year<m class='man'/></label>
								<select name="bill_month" id="to_billing_month" style="width: 56%;margin-left: 0px;">
							...
							<div class="span6">
								...
								<select name="bill_year" id="to_billing_year" style="width: 56%;">
