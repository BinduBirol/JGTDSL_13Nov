...
public class StartupResources  extends HttpServlet {
	...
	{			
		...
		config.getServletContext().setAttribute("DEPOSIT_PURPOSE_FROM_DATABASE",DepositService.getDepositPurposeList());
		...
		config.getServletContext().setAttribute("STATUS_STR",CustomerService.getStatusTypes());
