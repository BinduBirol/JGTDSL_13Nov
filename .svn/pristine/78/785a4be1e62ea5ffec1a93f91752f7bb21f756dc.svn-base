...
function valiateFields(){
	 ...
	 if(bill_for=="area_wise")
	 	isValid=validateField("area_id","bill_generation_date","bill_due_date");
	 else if(bill_for=="category_wise")
	 	isValid=validateField("area_id","customer_category","bill_generation_date","bill_due_date");
	 else if(bill_for=="individual_customer")
	 	isValid=validateField("customer_id","bill_generation_date","bill_due_date");
