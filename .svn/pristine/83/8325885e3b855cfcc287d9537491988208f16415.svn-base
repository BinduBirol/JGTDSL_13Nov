...
public class CustomerConnectionDTO {
	...
	private String hassub_connection;
	...
	public String getHassub_connection() {
		return hassub_connection;
	}

	public void setHassub_connection(String hassub_connection) {
		this.hassub_connection = hassub_connection;
	}

	public String getSub_connection() {
		return sub_connection;
	}

	public void setSub_connection(String sub_connection) {
		this.sub_connection = sub_connection;
	}
