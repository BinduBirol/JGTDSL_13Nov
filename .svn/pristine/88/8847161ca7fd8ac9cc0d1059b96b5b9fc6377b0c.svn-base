     				...
     				<form id="billProcessForm" name="billProcessForm" action="defaulterCustomerInfo.action" style="margin-bottom: 1px;">
								...
								<div class="alert alert-info">
									<table width="100%" align="center">
										<tr>
											...
											<s:if  test="#session.role=='Super Admin' || #session.role=='Bank User' ||#session.role=='RDD'">
												<input type="radio" value="all_area" id="all_area" name="report_for" onclick="checkType(this.id)" /> All Area&nbsp;&nbsp;&nbsp;	
											</s:if>											
						...
						<div class="row-fluid">							
							<div class="span6">									    
								...
								<select id="area_id"  style="width: 56%;"   name="area" onchange="fetchSelectBox(zone_sbox)" onkeypress="selectvalue.apply(this, arguments),fetchSelectBox(zone_sbox)">
