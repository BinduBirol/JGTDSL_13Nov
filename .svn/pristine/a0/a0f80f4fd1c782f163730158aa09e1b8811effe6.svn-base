		...
		<div class="span12" id="rightSpan">
			<div class="w-box">
				<div class="w-box-header">
    				<h4 id="rightSpan_caption">Ministry Collection-Due Report</h4>
				</div>
									...
									<table width="100%" align="center">
										<tr>
											<td width="100%" align="right" style="font-size: 12px;font-weight: bold;">
												...
												<input type="radio" value="combo" id="mini_coll_area_wise" name="report_for" onclick="checkType(this.id)"/>&nbsp;Combined Area&nbsp;&nbsp;&nbsp;
