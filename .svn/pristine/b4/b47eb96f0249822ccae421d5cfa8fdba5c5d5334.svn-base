...
public class MeterInformationService {
	...
	{		
		...
		String sql2="Update CUSTOMER_CONNECTION Set VAT_REBATE=? Where customer_id=? ";
		...
		try
		{
			...
			updateStmt.setDouble(1,meter.getVat_rebate());
			updateStmt.setString(2,meter.getCustomer_id());
			updateStmt.addBatch();
