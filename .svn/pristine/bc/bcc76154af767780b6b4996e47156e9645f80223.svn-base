...
<link rel="stylesheet"
	href="/JGTDSL_WEB/resources/thirdParty/smart-wizard/styles/smart_wizard.css">
<script
	src="/JGTDSL_WEB/resources/thirdParty/smart-wizard/js/jquery.smartWizard.js"></script>
		...
		<form id="newCustomerForm" name="newCustomerForm">
			<div class="w-box">
				...
				<div class="w-box-content" style="height: 103%;">
					<!-- w-box-content in theme, common.js, constant.js, beoro.css -->
					<div class="row-fluid">
						<div class="span12">
							<div id="wizard" class="swMain">
								<ul>
									<li><a href="#sw-basic-step-1"> <span
											class="stepNumber">1</span> <span class="stepDesc">
												Step 1<small>Personal Information</small>
										</span>
									</a></li>
									<li><a href="#sw-basic-step-2"> <span
											class="stepNumber">2</span> <span class="stepDesc">
...
//	}
	...
	function validateStep1() {
		...
		if (validateCustomerId() == false) {
			cbColor($("#id_category"), "e");
			cbColor($("#id_area"), "e");
			cbColor($("#id_code"), "e");
			isValid = false;
		} else {
			cbColor($("#id_category"), "v");
			cbColor($("#id_area"), "v");
			cbColor($("#id_code"), "v");
		}
		if ($.trim($("#gender").val()) == "") {
			...
			cbColor($("#gender"), "v");
		if ($("#customer_category").val() != "01"
				&& $("#customer_category").val() != "02") {
			if ($.trim($("#proprietor_name").val()) == "") {
				cbColor($("#proprietor_name"), "e");
				isValid = false;
			} else
				cbColor($("#proprietor_name"), "v");
		}

		isValid = validateField("full_name", "father_name", "mother_name", "gender", "mobile", "customer_category", "area_id");
		//isValid = validateField("full_name", "father_name", "mother_name", "gender", "customer_category", "area_id");
		
		// mobile number validation ...... GP launch 013 series 
		// @sujon
	...
	function validateStep2() {
		...
		isValid = validateField("division_id", "division_id", "upazila_id",
				"road_house_no");
	...
	function validateCustomerId() {
		...
		//}
		var customer_id = $("#id_area").val() + $("#id_category").val()
				+ $("#id_code").val();
		if ($.trim(customer_id) == "")
			return false;
