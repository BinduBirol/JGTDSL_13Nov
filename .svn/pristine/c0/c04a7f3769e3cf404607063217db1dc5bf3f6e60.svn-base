...
public class FetchDefaulter extends BaseAction{
	...
	public String execute()
	{
		...
		String str= "";
		// filtered customer will be inserted into temp table 
		
		if(dType==1){
			str=smsService.saveSMSDefaulter(areaId, customerCategory, billMonth, billYear, monthNumber, dueDate);
		}else{
			str=smsService.saveSMSnonDefaulter(areaId, customerCategory, billMonth, billYear,dueDate);
		}				
