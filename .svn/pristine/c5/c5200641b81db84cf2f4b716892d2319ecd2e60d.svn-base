									...
									<table width="85%" align="center">
										<tr>
											<td width="100%" align="left" style="font-size: 12px;font-weight: bold;">
												...
												<input type="radio" value="bank_wise_f_allarea" id="bank_wise_f_allarea" name="report_for" onclick="checkType(this.id)" /> Bank Wise all area&nbsp;&nbsp;&nbsp;
												</s:if>
												
												<input type="radio" value="all_bank_wise_monthly" id="all_bank_wise_monthly" name="report_for" onclick="checkType(this.id)" /> All Bank&nbsp;&nbsp;&nbsp;
												<input type="radio" value="all_area_gp_collection" id="all_area_gp_collection" name="report_for" onclick="checkType(this.id)" /> GP All Area&nbsp;&nbsp;&nbsp;
												<input type="radio" value="all_area_robi_collection" id="all_area_robi_collection" name="report_for" onclick="checkType(this.id)" /> Robi All Area&nbsp;&nbsp;&nbsp;
											</td>											
										</tr>
									</table>
                                </div>
