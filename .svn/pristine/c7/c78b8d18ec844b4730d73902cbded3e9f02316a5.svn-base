...
jQuery("#customer_grid")
    .jqGrid({
        ...
        colNames: ['Deposit Id', 'Customer Id', 'Customer Name','Bank','Branch','Account','Valid Till','Total Deposit','Expire In (Days)','Download'],
        colModel: [{
	                name: 'deposit_id',
	                index: 'deposit_id',
	                width: 70,
                ...
                ,
                {
            		...
            		align:'center',
            		formatter:function(){
                          return "<a><span class='ui-icon ui-icon-circle-arrow-s' style='margin-left:3px;'></span></a>";
                    },
                    cellattr: function (rowId, tv, rowObject, cm, rdata) {
                            return ' onClick="window.location=\'BGforIndividual.action?download_type=S&customer_id='+rowObject.customer_id+'\'"';
                    }
            	}
        ],
