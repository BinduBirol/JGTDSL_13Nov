...
public class SMSService {
	...
	public String saveSMSnonDefaulter(String areaId, String customerCategory, String billMonth, String billYear, String dueDate)
	{
		
		Connection conn = ConnectionManager.getConnection();
		OracleCallableStatement stmt = null;
		try {			
			 stmt = (OracleCallableStatement) conn.prepareCall("{ call Save_Sms_Non_Defaulter(?,?,?,?,?)  }");	         
