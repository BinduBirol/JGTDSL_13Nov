									...
									<table width="100%" align="center">
										<tr>
											<td width="100%" align="left" style="font-size: 12px;font-weight: bold;">
												<input type="radio" value="area_wise" id="area_wise" name="report_for" checked="checked" onclick="checkType(this.id)"/> Area Wise&nbsp;&nbsp;&nbsp;
												...
												<input type="radio" value="disconnected" id="disconnected" name="report_for" onclick="checkType(this.id)" /> Disconn Cust Category wise&nbsp;&nbsp;&nbsp;
												<input type="radio" value="zone" id="zone" name="report_for" onclick="checkType(this.id)" /> Moholla wise&nbsp;&nbsp;&nbsp;
											</td>											
										</tr>
									</table>
                                </div>
...
<%-- 						<div class="row-fluid" id="from_to_date_div">							
						...
						<div class="formSep sepH_b" style="padding-top: 3px;margin-bottom: 0px;padding-bottom: 2px;">		
						   <table width="100%">
						   	<tr>
						   		<td align="left"><p class="alert alert-warning"> Moholla wise Non metered customer list is available</p></td>
	...
	if(type=="area_wise")
	{
	 ...
	 enableField("from_date");
		...
		disableField("customer_category");
		 ...
		 //disableField("customer_type");
		 showElement("meter_nonMeter");
		 disableField("from_date");
	}
