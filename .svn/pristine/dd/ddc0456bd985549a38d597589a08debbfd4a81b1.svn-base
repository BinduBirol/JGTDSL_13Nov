		...
		<div class="span12" id="rightSpan">
			<div class="w-box">
				...
				<div class="w-box-content" style="padding: 10px;" id="content_div">
     				...
     				<form id="" name="billProcessForm" action="balancingReport.action" style="margin-bottom: 1px;">		
     				...
     				<div class="row-fluid" id= "report_for_div">
									...
									<table width="100%" align="center">
										<tr>
											<td width="100%" align="right" style="font-size: 12px;font-weight: bold;">
												...
												<input type="radio" value="summary" id="" name="report_for" checked="checked" onclick="checkType(this.id)" /> Summary&nbsp;&nbsp;&nbsp;
												<input type="radio" value="details" id="" name="report_for" onclick="checkType(this.id)"/> Details&nbsp;&nbsp;&nbsp;										
						...
						<div class="row-fluid"  style="width: 100%;" id="type">
						
						
							<div class="span6">									    
								<label style="width: 40%">Customer Type</label>
								<select id="area_id"  style="width: 56%;"   name="cus_type">			
									
										<option selected="selected" value="1" >Metered</option>
										<option selected="selected" value="0" >Non-Metered</option>
