...
<div class="row-fluid">
		...
		<div style="width: 100%;float: left;margin-top: 0px;">
			<div class="w-box">
				...
				<div class="w-box-content" style="padding: 10px;" id="content_div">												
						 ...
						 <div class="row-fluid">
						  	<div class="span6 extra">
								<label style="width: 30%">Vat Rebate</label>	
								<input type="text" style="width: 65%"  name="personal.vat_rebate" id="vat_rebate" />																	
						  	</div>				  			  			
						 </div>
						 
						 <input type="hidden" id="check_role" value="<s:property value="%{#session.role}" />"/>						 	
				<div id="for_admin_only" >
						 <div class="row-fluid">
						 <div class="span6 extra">
			                    <label style="width: 30%">Connection Satus</label>	
			                    <select name="customer.connectionInfo.status_str" id="statusList"  style="width: 65%;">		
			                     <option selected="selected">Status</option>	                        
			                        <s:iterator value="%{#application.STATUS_STR}" id="">			                       
			                            <option value="<s:property value="status_str" />" >
						  ...
						  <div class="span6 extra">
								<label style="width: 30%">Connection Date </label>	
								<input type="text" style="width: 65%"  name="customer.connectionInfo.connection_date" id=co_date />																	
						  	</div>				  	 			
						 </div>
						 
						 <div class="row-fluid">
							 	<div class="span6 extra">
							 	<label style="width: 30%">Bulk Status </label>	
							 	<input type="radio" id="radio_Y" name="personal.bulk_sataus" value="Y">Yes
								<input type="radio" id="radio_undefined" name="personal.bulk_sataus" value="N"> No<br>
								</div>
							 </div>	
						...
						<div class="row-fluid">
							...
							<div class="span6 extra">
								<label style="width: 60%;font-weight: bold">Parent Customer (For mixed customers)</label>	
								<input type="text" style="width: 65%"  name="personal.parent_customer" id="parent_customer" />							
	...
	<div style="width: 38%;height: 98%;float: left;margin-left: 15px;">	
		...
		<div style="width: 100%;float: left;margin-top: 0px;">s
