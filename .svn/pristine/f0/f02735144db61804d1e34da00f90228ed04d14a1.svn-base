...
public class CollectionBankStatement extends BaseAction {
	...
	public String execute() throws Exception
	{
		...
		try{
			...
			if(!report_for.equals("all_area_robi_collection") && (!report_for.equals("all_area_gp_collection"))){
				
				if(report_for.equals("bank_wise_f_allarea")){
					
					Chunk chunk1 = new Chunk("Combined Report : ",ReportUtil.f9B);
				...
				Chunk chunk1 = new Chunk("REGIONAL OFFICE : ",ReportUtil.f9B);
				Chunk chunk2 = new Chunk("Head Office",ReportUtil.f9B);
				Paragraph p = new Paragraph(); 
				p.add(chunk1);
				p.add(chunk2);
				pcell=new PdfPCell(p);
			...
			}else if(report_for.equals("all_area_gp_collection")){
				generatePdfMonth_wiseAllGpCollection(document);
			}else if(report_for.equals("all_area_robi_collection")){
				generatePdfMonth_wiseAllRobiCollection(document);
			}else if(report_for.equals("bank_wise_f_allarea")){
				generatePdfBank_wise(document);
			}
...
//			headLinetable.addCell(pcell);
	...
	/*	All area robi collection
	 * 
	 * @sujon
	 * */
	private void generatePdfMonth_wiseAllRobiCollection(Document document) throws DocumentException
	{
		...
		pcell=new PdfPCell(new Paragraph("ALL AREA ROBI COLLECTION STATEMENT FOR THE MONTH "+Month.values()[Integer.valueOf(collection_month)-1]+", "+collection_year,ReportUtil.f9B));
		pcell.setMinimumHeight(18f);
		pcell.setHorizontalAlignment(Element.ALIGN_CENTER);
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setBorder(0);
...
//		double forwardBalance=getForwardBalanceMonthwise();
		...
		pcell = new PdfPCell(new Paragraph(": ROBI",ReportUtil.f9));
		pcell.setHorizontalAlignment(Element.ALIGN_LEFT);
		pcell.setBorder(0);
		middleTable.addCell(pcell);
		...
		pcell = new PdfPCell(new Paragraph(": All Area Branch",ReportUtil.f9));
		pcell.setHorizontalAlignment(Element.ALIGN_LEFT);
		pcell.setBorder(0);
		middleTable.addCell(pcell);
		...
		pcell = new PdfPCell(new Paragraph(": Dhaka",ReportUtil.f9));
		pcell.setHorizontalAlignment(Element.ALIGN_LEFT);
		pcell.setBorder(0);
		middleTable.addCell(pcell);
		...
		pcell = new PdfPCell(new Paragraph(taka_format.format(0),ReportUtil.f9));
		pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		pcell.setBorder(0);
		middleTable.addCell(pcell);
		...
		pdfPTable.setWidthPercentage(100);
		pdfPTable.setWidths(new float[]{5,10,30,15,13,12,15});
		pdfPTable.setHeaderRows(1);
		...
		pcell = new PdfPCell(new Paragraph("Month of Bill",ReportUtil.f9B));
		pcell.setHorizontalAlignment(Element.ALIGN_CENTER);
		pcell.setColspan(1);
		pdfPTable.addCell(pcell);
		
		pcell = new PdfPCell(new Paragraph("Deposit (Tk.)",ReportUtil.f9B));
		pcell.setHorizontalAlignment(Element.ALIGN_CENTER);
		pcell.setColspan(1);
		pdfPTable.addCell(pcell);
		
		pcell = new PdfPCell(new Paragraph("Withdrawal (Tk.)",ReportUtil.f9B));
		pcell.setHorizontalAlignment(Element.ALIGN_CENTER);
		pcell.setColspan(1);
		pdfPTable.addCell(pcell);
		
		pcell = new PdfPCell(new Paragraph("Balance (Tk.)",ReportUtil.f9B));
		pcell.setHorizontalAlignment(Element.ALIGN_CENTER);
		pcell.setColspan(1);
		pdfPTable.addCell(pcell);
		//document.add(pdfPTable);
		...
		pcell = new PdfPCell(new Paragraph("Balance Forward :",ReportUtil.f9B));
		pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		pcell.setColspan(6);
		pcell.setBorderColorRight(BaseColor.WHITE);
		pdfPTable.addCell(pcell);
		...
		transactionList=getMonthlyRobiTransactionList();
		int listSize=transactionList.size();
		double balance=0;
		double subTotalDebit=0.0;
		double subTotalCredit=0.0;
		...
		for(int i=0;i<listSize;i++)
		{
			...
			if(!currentDate.equals(previousDate)){
				...
				if(i>0){
					...
					pcell = new PdfPCell(new Paragraph(taka_format.format(daywiseSubTotalDebit),ReportUtil.f9B));
					pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
					pcell.setColspan(1);
					pdfPTable.addCell(pcell);
					
					pcell = new PdfPCell(new Paragraph(taka_format.format(daywiseSubTotalCredit),ReportUtil.f9B));
					pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
					pcell.setColspan(1);
					pdfPTable.addCell(pcell);
					
					pcell = new PdfPCell(new Paragraph(taka_format.format(daywiseSubTotalBalance),ReportUtil.f9B));
					pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
					pcell.setColspan(1);
					pdfPTable.addCell(pcell);
				...
				pcell = new PdfPCell(new Paragraph(transactionList.get(i).getTrans_date(),ReportUtil.f9B));
				pcell.setHorizontalAlignment(Element.ALIGN_LEFT);
				pcell.setColspan(7);
				pdfPTable.addCell(pcell);
			...
			pcell = new PdfPCell(new Paragraph(transactionList.get(i).getBillMonth(),ReportUtil.f7));
			pcell.setHorizontalAlignment(Element.ALIGN_LEFT);
			pcell.setColspan(1);
			pdfPTable.addCell(pcell);
	...
	/*	All area GP collection for rabiul
	 * 
	 * @sujon
	 * */
	
	private void generatePdfMonth_wiseAllGpCollection(Document document) throws DocumentException
	{
		...
		pcell=new PdfPCell(new Paragraph("ALL AREA GP COLLECTION STATEMENT FOR THE MONTH "+Month.values()[Integer.valueOf(collection_month)-1]+", "+collection_year,ReportUtil.f9B));
		pcell.setMinimumHeight(18f);
		pcell.setHorizontalAlignment(Element.ALIGN_CENTER);
		pcell.setVerticalAlignment(Element.ALIGN_MIDDLE);
		pcell.setBorder(0);
...
//		double forwardBalance=getForwardBalanceMonthwise();
		...
		pcell = new PdfPCell(new Paragraph(": Grameen Phone",ReportUtil.f9));
		pcell.setHorizontalAlignment(Element.ALIGN_LEFT);
		pcell.setBorder(0);
		middleTable.addCell(pcell);
		...
		transactionList=getMonthlyGPTransactionList();
		int listSize=transactionList.size();
		double balance=0;
		double subTotalDebit=0.0;
		double subTotalCredit=0.0;
...
/*	private AccountDTO getAccountInfo()
	...
	*/
	...
	/* Monthly collection for robi only
	 * 
	 * @sujon
	 * */
	
	private ArrayList<TransactionDTO> getMonthlyRobiTransactionList()
	{
	...
	String wClause="";
		...
		try {
			...
			String transaction_sql="SELECT TRANS_DATE, " +
									...
									"         LEFT OUTER JOIN MVIEW_CUSTOMER_INFO mcf " +
									"            ON tbl.CUSTOMER_ID = mcf.CUSTOMER_ID " +
									"ORDER BY TRANS_DATE ASC, tbl.CUSTOMER_ID " ;
	...
	/* 	monthly collection for only gp
	 * 
	 * @sujon
	 * */
	
	private ArrayList<TransactionDTO> getMonthlyGPTransactionList()
	{
	ArrayList<TransactionDTO> transactionListDetails=new ArrayList<TransactionDTO>();
	//String area=loggedInUser.getArea_id();
	String wClause="";
...
//	}
	...
	if(report_for.equals("bank_wise_f_allarea")){
		...
		wcluse1=  "  MBRI.AREA_ID in (select area from USER_AREAS where USERID='"+loggedInUser.getUserId()+"') AND TRANS_TYPE = 1 " ;
		wcluse2=  "  MBRI.AREA_ID in (select area from USER_AREAS where USERID='"+loggedInUser.getUserId()+"') AND TRANS_TYPE = 7 " ;
		wcluse3=  "  MBRI.AREA_ID in (select area from USER_AREAS where USERID='"+loggedInUser.getUserId()+"') AND TRANS_TYPE = 0 " ;
				 	
	}else{
		wcluse1="   TRANS_TYPE = 1 " +
				"  AND MBRI.AREA_ID ='"+area+"' " ;
		
		wcluse2="   TRANS_TYPE = 7 " +
				"  AND MBRI.AREA_ID ='"+area+"' " ;
		
		wcluse3="   TRANS_TYPE = 0 " +
				"  AND MBRI.AREA_ID ='"+area+"' " ;
	}
