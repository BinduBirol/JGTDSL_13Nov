				...
				<div id="new_metered_customer_creation_div"
					...
					<form id="meterForm" name="" >
						...
						<div class="row-fluid" style="margin-left: 5px;">
							...
							<input id="readonly_metered" type="text" id="" readonly="readonly" style="border: 1px solid #add9e4;width:32px;;font-weight: bold;color: blue;"/>
							<input name="newExtention" placeholder="Serialz" type="text"
								id="extention_meter" maxlength="10"
								style="border: 1px solid #add9e4;width: 15%;;font-weight: bold;color: blue;" />
				...
				<div id="new_non_metered_customer_creation_div"
					...
					<form id="nonMeterForm" name="" >
						...
						<div class="row-fluid" style="margin-left: 5px;">
							...
							<input type="text" id="readonly_non_metered" id="" readonly="readonly" style="border: 1px solid #add9e4;width:32px;;font-weight: bold;color: blue;"/>
							<input name="newExtention" type="text" id="extention_non_meter"
