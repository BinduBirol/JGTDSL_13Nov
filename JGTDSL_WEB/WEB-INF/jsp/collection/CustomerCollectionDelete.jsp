		...
		<div class="span12" id="rightSpan">
			<div class="w-box">
				<div class="w-box-header">
					<h4 id="rightSpan_caption">Collection list to Delete</h4>
				</div>
				...
				<div class="w-box-content" id="content_div">
					<div class="formSep sepH_b"
						...
						<input type="hidden" id="areaId" name="areaId"
							value="<s:property value='areaId'/>" /> <input type="hidden"
							id="customerCategory" name="customerCategory"
							value="<s:property value='customerCategory'/>" /> <input
							type="hidden" id="billMonth" name="billMonth"
							value="<s:property value='billMonth'/>" /> <input type="hidden"
							id="billYear" name="billYear"
							value="<s:property value='billYear'/>" />
								...
								<s:iterator value="collectionList">
									<tr>
										<td id="scroll_no" align="center"><s:property
												value="scroll_no" /></td>
										<td id="collection_date" align="center"><s:property value="collection_date" /></td>
										...
										<td align="center"><s:property value="collection_amount" />
										</td>
										<td align="center"><s:property
												value="surcharge_collected" /></td>
										<td align="center"><s:property value="bank_name" /></td>
										
										<td align="center"><input type="button"
											class="btn btn-danger" id="btn_delete"
											onclick="deleteWrongCollection('<s:property value="scroll_no" />')"
											value="Delete"></td>
									</tr>
								</s:iterator>
							</tbody>
