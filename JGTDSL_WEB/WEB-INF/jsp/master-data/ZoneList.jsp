<script type="text/javascript">
	navCache("getCustomerCategoryList.action");
	setTitle("List of Available Customer Categories");
</script>
<div id="gridWrapper">
...
<script type="text/javascript" src="/JGTDSL_WEB/resources/js/page/ZoneGrid.js"></script>
