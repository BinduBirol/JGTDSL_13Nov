...
<script type="text/javascript">
	...
	setTitle("Monthly Collection Report");
</script>
		...
		<div class="span12" id="rightSpan">
			<div class="w-box">
				<div class="w-box-header">
					<h4 id="rightSpan_caption">Ministry Collection Report</h4>
				</div>
				<div class="w-box-content" style="padding: 10px;" id="content_div">

					<form id="billProcessForm" name="billProcessForm"
						action="ministryCollectionReport.action"
						style="margin-bottom: 1px;">

						<div class="row-fluid">
							<div class="span6">
								<label style="width: 40%">Region/Area</label> <select
									id="area_id" style="width: 56%;" name="area">
									<option value="">Select Area</option>
									<s:iterator value="%{#session.USER_AREA_LIST}" id="areaList">
										<option selected="selected"
											value="<s:property value="area_id" />">
						...
						<div class="row-fluid">
							<div class="span6">
								...
								<select name="coll_month" id="billing_month"
									style="width: 56%;margin-left: 0px;">
							...
							<div class="span6">
								...
								<select name="coll_year" id="billing_year" style="width: 56%;">
...
<script type="text/javascript"
	src="/JGTDSL_WEB/resources/js/page/salesReport.js"></script>
