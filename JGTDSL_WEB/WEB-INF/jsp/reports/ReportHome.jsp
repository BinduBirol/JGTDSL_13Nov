		  ...
		  <div class="box-collection">
		    <ul class="column">
				<s:if test="%{reportType=='sales'}">
					...
					<li class="boxG" onclick="ajaxLoad('report_input_div','ministryCollectionDetailsView.action')"><span>Ministry Sales</span> </li>
				...
				<s:if test="reportType=='collection'">
					...
					<li class="boxV" onclick="ajaxLoad('report_input_div','codelessCollectionReportForm.action')"><span>Codeless Collection</span> </li>
					<li class="boxV" onclick="ajaxLoad('report_input_div','ministryCollectionReportForm.action')"><span>Ministry Collection</span> </li>						
					...
					<li class="boxV" onclick="ajaxLoad('report_input_div','freedomFighterCollectionInfoForm.action')"><span>Freedom Fighter Collection Info</span> </li>
					<li class="boxV" onclick="ajaxLoad('report_input_div','CashAndBGReportsInfoForm.action')"><span>Cash & BG Reports</span> </li>
					<li class="boxV" onclick="ajaxLoad('report_input_div','areaWiseAdvCollectionHome.action')"><span>Area Wise Advance Collection</span> </li>
				...
				<s:if test="reportType=='preprinted'">
					<script  type="text/javascript">
						navCache("reportHome.action?reportType=preprinted");
						setTitle("Pre Printed Reports");
					</script>
					<li class="boxV" onclick="ajaxLoad('report_input_div','security_bg_notice.action')"><span>BG notice</span> </li>
					<li class="boxV" onclick="ajaxLoad('report_input_div','due_bill_notice_home.action')"><span>Due Bill notice</span> </li>
					<li class="boxV" onclick="ajaxLoad('report_input_div','max_load_exceed_notice_home.action')"><span>Max load exceed notice</span> </li>
				</s:if>
				<s:if test="reportType=='mpg_dashboard'">
					<script  type="text/javascript">
						navCache("reportHome.action?reportType=margin");
						setTitle("Margin Reports");
					</script>					
