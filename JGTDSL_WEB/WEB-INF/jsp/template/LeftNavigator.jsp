	...
	<section>
		...
		<div>
			<div class="list-group">
				...
				<a href="javascript:void(0)" onclick="callAction('getZoneList.action')" class="list-group-item">
					<img src="/JGTDSL_WEB/resources/images/icons/sb_area_16.png" />
					Moholla Information
				</a>
			...
			<div class="list-group">
				<a href="javascript:void(0)" onclick="callAction('billCollectionHome.action')" class="list-group-item">
			  	...
			  	<a href="javascript:void(0)" onclick="callAction('billCreationHome.action?bill_parameter.isMetered_str=ministry')" class="list-group-item">
					<img style="width:20px;height:20px;" src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/84/Government_Seal_of_Bangladesh.svg/220px-Government_Seal_of_Bangladesh.svg.png" />
					Bill Collection(Ministry) 
				</a>
				
				<a href="javascript:void(0)" onclick="callAction('billCreationHome.action?bill_parameter.isMetered_str=FFCollection')" class="list-group-item">
					<img style="width:20px;height:20px;" src="https://nabichowdhury.files.wordpress.com/2010/01/freedom1.jpg" />
					FF Collection 
				</a>
			  	
			  	<a href="javascript:void(0)" onclick="callAction('deleteCollection.action')" class="list-group-item">
			  		<img src="/JGTDSL_WEB/resources/images/icons/sb_collection_16.png" />
			  		Delete Bank Collection</a>
			  		
			  		<a href="javascript:void(0)" onclick="callAction('deleteCustomerCollectionHome.action')" class="list-group-item">
			  		<img src="/JGTDSL_WEB/resources/images/icons/sb_collection_16.png" />
			  		Delete Customer Collection</a>
...
<s:if  test="#session.role=='Super Admin' || #session.role=='Manager' || #session.role=='Assistant Manager' || #session.role=='Bank User' ||#session.role=='RDD'">
<section>
	<h3>
		<span class="z-icon">
	...
	<div>
		<div class="list-group">
		  ...
		  <a href="javascript:void(0)" onclick="callAction('reportHome.action?reportType=margin')" class="list-group-item">
		   ...
		   <a href="javascript:void(0)" onclick="callAction('reportHome.action?reportType=preprinted')" class="list-group-item">
		  	<img src="/JGTDSL_WEB/resources/images/icons/sb_report_others_16.png" />
		  	Pre Printed
		  </a>		  
...
<s:if test="#session.role=='Super Admin' || #session.role=='Manager' || #session.role=='Assistant Manager'||#session.role=='RDD'">
	<section>
	<h3>
		<span class="z-icon">
...
<s:if test="#session.role=='Super Admin'|| #session.role=='MPG'">
	<section>
	<h3>
		<span class="z-icon">
			<i class="fa fa-gears baseline"> </i>
	...
	<div>
		<div class="list-group">
		  <a href="javascript:void(0)" onclick="callAction('mpgDashboard.action')" class="list-group-item">						  
					  <img src="/JGTDSL_WEB/resources/images/icons/sb_authorization_16.png" />
					  MPG Dashboard
		  		</a></div>
		  <div class="list-group">
...
<div>
	<div class="list-group">
		  ...
		  <a href="javascript:void(0)" onclick="callAction('changeCustomerId.action')" class="list-group-item">
		  		<img style="height:23px; width:23px;" src="/JGTDSL_WEB/resources/images/IDchange.png" />
		  		Change Customer ID
		  </a>
		  <!-- 
