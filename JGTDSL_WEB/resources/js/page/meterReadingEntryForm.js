...
{	
	...
	if(reading_purpose==2){
		//General Billing || $("#customer_id").val()==
		if($("#measurement_type_str").val() == 1 || $("#customer_category").val()==13 || $("#customer_category").val()==08  || $("#customer_id").val()=="100400040"||$("#customer_id").val()=="100600001"||$("#customer_id").val()=="100400041"||$("#customer_id").val()=="100400042" ){
