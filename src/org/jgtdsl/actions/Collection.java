...
public class Collection extends BaseAction{
	...
	///////////ministry////////////
	public String saveMinistryBillCollection(){
		UserDTO loggedInUser=(UserDTO)session.get("user");
		CollectionService collectionService=new CollectionService();
		collection.setInserted_by(loggedInUser.getUserId());
		ResponseDTO response=collectionService.saveBillCollectionMinistry(collection);
		setJsonResponse(response);
		return null;
	}
	///////////////ministry//////////////
	...
	public String saveFFCollection(){
		BillingService FFcollectionService=new BillingService();
		ResponseDTO response=FFcollectionService.saveFFCollection(FFCollection);
		setJsonResponse(response);
        return null;		
	}
