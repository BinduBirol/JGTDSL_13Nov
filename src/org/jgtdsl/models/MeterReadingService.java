...
public class MeterReadingService {
	...
	public ResponseDTO saveMeterReading(String user_id,MeterReadingDTO reading)
	{
		...
		String sql=" Insert into METER_READING(READING_ID,CUSTOMER_ID,METER_ID,TARIFF_ID,RATE,billing_month, " +
				   ...
				   " HHV_NHV,MIN_LOAD,MAX_LOAD,PMIN_LOAD,PMAX_LOAD,ACTUAL_CONSUMPTION,TOTAL_CONSUMPTION,METER_RENT,PRESSURE," +
				   "PRESSURE_FACTOR,TEMPERATURE,TEMPERATURE_FACTOR,REMARKS,INSERT_BY) " +
		...
		if((totalDayDiff4mConnDateToReadingDate<=365&&(customer.getCustomer_category().equals("04")||customer.getCustomer_category().equals("05")||customer.getCustomer_category().equals("06")||customer.getCustomer_category().equals("07")||customer.getCustomer_category().equals("08")))||reading.getReading_purpose_str().equals("10"))
