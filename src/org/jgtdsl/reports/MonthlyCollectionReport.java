...
public class MonthlyCollectionReport extends BaseAction {
	...
	static DecimalFormat taka_format_BD = new DecimalFormat("#,####,##,##,##0.00");
	...
	private static void aday_bokeya(Document document) throws DocumentException
	{
...
//		System.out.println(totalTillPreviousMonthDues);
		...
		pcell = new PdfPCell(new Paragraph(taka_format.format(totalEquiAvgDuesMonth),ReportUtil.f10B));
		pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		pcell.setColspan(1);
		pdfPTable.addCell(pcell);
		...
		pcell = new PdfPCell(new Paragraph(taka_format.format(totalDisConEquiAvgDuesMonth),ReportUtil.f10B));
		pcell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		pcell.setColspan(1);
		pdfPTable.addCell(pcell);
