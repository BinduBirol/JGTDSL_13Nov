...
public class ReportFormatIPG extends PdfPageEventHelper
{  private static final long serialVersionUID = 1L;
   ...
   int count=0;
	...
	public ReportFormatIPG(ServletContext sContext) {
...
public void onEndPage(PdfWriter writer, Document document) {
	...
	try
	{
        ...
        // table.addCell("Printed time:"+new Date().toString());
         ...
         Paragraph footerMSG=new Paragraph("For any query please contact with JGTDSL help center: 16511",font2);
